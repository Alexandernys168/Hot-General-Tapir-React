...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Hot General Tapir</title>
        <meta property="og:title" content="Hot General Tapir" />
      </Helmet>
        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-nav5 bodySmall">Settings</span>
            </nav>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav51 bodySmall">Settings</span>
              </nav>
          ...
          <div className="home-features1">
            <div className="home-container2">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Experience the power of our patient information system
                    </span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="home-container3">
              ...
              <FeatureCard
                ...
                subHeading="Enables real-time updates and notifications"
              ></FeatureCard>
              <FeatureCard
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Intuitive and Secure Patient Data Management
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Our patient information system is designed to streamline data
                  entry and retrieval, ensuring efficient and secure access to
                  critical healthcare information. With event-driven
                  interactions and asynchronous data access, healthcare
                  providers can easily manage patient data and retrieve
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container5">
              ...
              ></Question1>
              <Question1
                answer="Event-driven interactions refer to the way the system responds to user actions or events, triggering specific actions or updates in real-time."
                question="What are event-driven interactions?"
              ></Question1>
              <Question1
                answer="Asynchronous data access refers to the ability of the system to retrieve and process data in a non-blocking manner, allowing users to continue interacting with the interface while data is being fetched."
                question="What is asynchronous data access?"
              ></Question1>
              <Question1
                answer="The system implements secure authorization workflows by requiring users to authenticate themselves and granting access only to authorized individuals based on their roles and permissions."
                question="How does the system ensure secure authorization workflows?"
              ></Question1>
              <Question1
                answer="The interface provides intuitive forms for entering patient data, with validation and error handling. It also offers a user-friendly dashboard for managing and tracking data retrieval requests, providing status updates and notifications."
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container6">
            ...
            <nav className="home-nav1 bodySmall home-nav1">
              ...
              <span className="home-nav52 bodySmall">Settings</span>
            </nav>
          </div>
